...
class Person:
    ...
    def get_stats(self):
        ...
        print(bcolors.BOLD + self.name + space + current_hp +
              " |" + bcolors.GREEN + hp_bar + bcolors.ENDC + "|     " +
    ...
    def choose_action(self):
        i = 1
        print("\n" + "    " + bcolors.BOLD + bcolors.CYAN + bcolors.UNDERLINE +
    ...
    def choose_magic(self):
        i = 1
        print("\n" + bcolors.BLUE + bcolors.BOLD + "    MAGIC:" + bcolors.ENDC)
